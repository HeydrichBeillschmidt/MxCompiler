...
entry:
	...
	%malloc = call i8* @_malloc$$YGPADH$Z(i32 4)
	%castToClassPtr = bitcast i8* %malloc to %class.vector*
	%malloc_2 = call i8* @_malloc$$YGPADH$Z(i32 44)
	%mallocInt32Ptr = bitcast i8* %malloc_2 to i32*
...
if.end:
	...
	%funcCallRet_9 = call %class.vector* @_scalarInPlaceMultiply$vector$$QEAUvector$$H$Z(%class.vector* %castToClassPtr_2, i32 8)
