...
for.cond_5:
	...
	%slt_5 = icmp slt i32 %i_15, 5
	br i1 %slt_5, label %for.body_5, label %for.end_5

for.body_5:
	%b_3 = load %class.rec**, %class.rec*** @b, align 4
	%i_16 = load i32, i32* @i, align 4
	%elementPtr_6 = getelementptr %class.rec*, %class.rec** %b_3, i32 %i_16
	%arrayElement_6 = load %class.rec*, %class.rec** %elementPtr_6, align 4
	%rec.num.addr_2 = getelementptr %class.rec, %class.rec* %arrayElement_6, i32 0, i32 0
	%rec.num_2 = load i32, i32* %rec.num.addr_2, align 4
	call void @_printNum$$YGXH$Z(i32 %rec.num_2)
	br label %for.inc_5

for.inc_5:
	%i_17 = load i32, i32* @i, align 4
	%postfix_inc_5 = add i32 %i_17, 1
	store i32 %postfix_inc_5, i32* @i, align 4
	br label %for.cond_5

for.end_5:
	%a_3 = load i32**, i32*** @a, align 4
	%elementPtr_7 = getelementptr i32*, i32** %a_3, i32 3
	%arrayElement_7 = load i32*, i32** %elementPtr_7, align 4
	%elementPtr_8 = getelementptr i32, i32* %arrayElement_7, i32 9
	%arrayElement_8 = load i32, i32* %elementPtr_8, align 4
	call void @_printNum$$YGXH$Z(i32 %arrayElement_8)
...
for.cond_6:
	...
	%sle = icmp sle i32 %i_19, 3
	br i1 %sle, label %for.body_7, label %for.end_7

for.cond_7:
	%j_6 = load i32, i32* @j, align 4
	%sle_2 = icmp sle i32 %j_6, 9
	br i1 %sle_2, label %for.body_6, label %for.end_6

for.body_6:
	%a_4 = load i32**, i32*** @a, align 4
	%i_20 = load i32, i32* @i, align 4
	%elementPtr_9 = getelementptr i32*, i32** %a_4, i32 %i_20
	%arrayElement_9 = load i32*, i32** %elementPtr_9, align 4
	%j_7 = load i32, i32* @j, align 4
	%elementPtr_10 = getelementptr i32, i32* %arrayElement_9, i32 %j_7
	%arrayElement_10 = load i32, i32* %elementPtr_10, align 4
	%i_21 = load i32, i32* @i, align 4
	%mul = mul i32 %i_21, 10
	%j_8 = load i32, i32* @j, align 4
	%add = add i32 %mul, %j_8
	store i32 %add, i32* %elementPtr_10, align 4
	br label %for.inc_6

for.inc_6:
	%j_9 = load i32, i32* @j, align 4
	%postfix_inc_6 = add i32 %j_9, 1
	store i32 %postfix_inc_6, i32* @j, align 4
	br label %for.cond_7
...
for.inc_7:
	...
	%postfix_inc_7 = add i32 %i_22, 1
	store i32 %postfix_inc_7, i32* @i, align 4
	br label %for.cond_6

for.end_7:
	%i_23 = load i32, i32* @i, align 4
	store i32 0, i32* @i, align 4
	br label %for.cond_8

for.cond_8:
	%i_24 = load i32, i32* @i, align 4
	%sle_3 = icmp sle i32 %i_24, 3
	br i1 %sle_3, label %for.body_9, label %for.end_9

for.cond_9:
	%j_11 = load i32, i32* @j, align 4
	%sle_4 = icmp sle i32 %j_11, 9
	br i1 %sle_4, label %for.body_8, label %for.end_8

for.body_8:
	%a_5 = load i32**, i32*** @a, align 4
	%i_25 = load i32, i32* @i, align 4
	%elementPtr_11 = getelementptr i32*, i32** %a_5, i32 %i_25
	%arrayElement_11 = load i32*, i32** %elementPtr_11, align 4
	%j_12 = load i32, i32* @j, align 4
	%elementPtr_12 = getelementptr i32, i32* %arrayElement_11, i32 %j_12
	%arrayElement_12 = load i32, i32* %elementPtr_12, align 4
	call void @_printNum$$YGXH$Z(i32 %arrayElement_12)
	br label %for.inc_8

for.inc_8:
	%j_13 = load i32, i32* @j, align 4
	%postfix_inc_8 = add i32 %j_13, 1
	store i32 %postfix_inc_8, i32* @j, align 4
	br label %for.cond_9
...
for.inc_9:
	%i_26 = load i32, i32* @i, align 4
	%postfix_inc_9 = add i32 %i_26, 1
	store i32 %postfix_inc_9, i32* @i, align 4
	br label %for.cond_8

for.end_9:
	%a_6 = load i32**, i32*** @a, align 4
	%elementPtr_13 = getelementptr i32*, i32** %a_6, i32 2
	%arrayElement_13 = load i32*, i32** %elementPtr_13, align 4
	%elementPtr_14 = getelementptr i32, i32* %arrayElement_13, i32 10
	%arrayElement_14 = load i32, i32* %elementPtr_14, align 4
	store i32 0, i32* %elementPtr_14, align 4
	%a_7 = load i32**, i32*** @a, align 4
	%elementPtr_15 = getelementptr i32*, i32** %a_7, i32 2
	%arrayElement_15 = load i32*, i32** %elementPtr_15, align 4
	%elementPtr_16 = getelementptr i32, i32* %arrayElement_15, i32 10
	%arrayElement_16 = load i32, i32* %elementPtr_16, align 4
	call void @_printNum$$YGXH$Z(i32 %arrayElement_16)
	%b_4 = load %class.rec**, %class.rec*** @b, align 4
	%elementPtr_17 = getelementptr %class.rec*, %class.rec** %b_4, i32 0
	%arrayElement_17 = load %class.rec*, %class.rec** %elementPtr_17, align 4
	%rec.num.addr_3 = getelementptr %class.rec, %class.rec* %arrayElement_17, i32 0, i32 0
	%rec.num_3 = load i32, i32* %rec.num.addr_3, align 4
	%prefix_neg_2 = sub i32 0, 2
	store i32 %prefix_neg_2, i32* %rec.num.addr_3, align 4
	%b_5 = load %class.rec**, %class.rec*** @b, align 4
	%a_8 = load i32**, i32*** @a, align 4
	%elementPtr_18 = getelementptr i32*, i32** %a_8, i32 2
	%arrayElement_18 = load i32*, i32** %elementPtr_18, align 4
	%elementPtr_19 = getelementptr i32, i32* %arrayElement_18, i32 10
	%arrayElement_19 = load i32, i32* %elementPtr_19, align 4
	%elementPtr_20 = getelementptr %class.rec*, %class.rec** %b_5, i32 %arrayElement_19
	...
	store i32 %prefix_neg_3, i32* %rec.num.addr_4, align 4
	%b_6 = load %class.rec**, %class.rec*** @b, align 4
	%elementPtr_21 = getelementptr %class.rec*, %class.rec** %b_6, i32 0
	...
	%b_7 = load %class.rec**, %class.rec*** @b, align 4
	%elementPtr_22 = getelementptr %class.rec*, %class.rec** %b_7, i32 1
	%arrayElement_22 = load %class.rec*, %class.rec** %elementPtr_22, align 4
	%rec.num.addr_6 = getelementptr %class.rec, %class.rec* %arrayElement_22, i32 0, i32 0
	%rec.num_6 = load i32, i32* %rec.num.addr_6, align 4
	call void @_printNum$$YGXH$Z(i32 %rec.num_6)
