...
for.cond:
	%j_7 = phi i32 [ 0, %entry ], [ %j_6, %if.end_2 ]
	%flag_3 = phi i1 [ 0, %entry ], [ %flag_6, %if.end_2 ]
...
return:
	%j_8 = phi i32 [ %j_6, %if.then_2 ], [ %j_7, %for.end_2 ]
	%flag_4 = phi i1 [ %flag_6, %if.then_2 ], [ %flag_3, %for.end_2 ]
