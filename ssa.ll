...
for.cond:
	%v_2 = phi i32 [ 0, %entry ], [ %funcCallRet_4, %for.body ]
	%i_4 = phi i32 [ 0, %entry ], [ %prefix_inc, %for.body ]
	%w_2 = phi i32 [ 0, %entry ], [ %funcCallRet_5, %for.body ]
	%u_2 = phi i32 [ 0, %entry ], [ %funcCallRet_3, %for.body ]
...
while.cond:
	...
	%p_4 = phi i32 [ 0, %entry ], [ %funcCallRet_2, %if.end ]
...
while.end:
	%p_5 = phi i32 [ %funcCallRet_2, %if.then ], [ %p_4, %while.cond ]
	ret void
}
...
for.cond:
	%d_3 = phi i32* [ null, %entry ], [ %funcCallRet, %for.end ]
	%i_5 = phi i32 [ 0, %entry ], [ %prefix_inc_2, %for.end ]
	%j_6 = phi i32 [ 0, %entry ], [ %j_7, %for.end ]
...
for.body:
	...
	store i32 %prefix_neg, i32* %elementPtr, align 4
...
for.body_2:
	...
	store i32 %prefix_neg_2, i32* %elementPtr_2, align 4
...
while.cond:
	%node_6 = phi %class.Node* [ null, %for.end ], [ %funcCallRet_2, %if.then ], [ %node_8, %for.end_2 ]
	%v_6 = phi i32 [ 0, %for.end ], [ %v_6, %if.then ], [ %v_5, %for.end_2 ]
	%alt_4 = phi i32 [ 0, %for.end ], [ %alt_4, %if.then ], [ %alt_3, %for.end_2 ]
	%k_8 = phi i32 [ 0, %for.end ], [ %k_8, %if.then ], [ %k_7, %for.end_2 ]
	%w_3 = phi i32 [ 0, %for.end ], [ %w_3, %if.then ], [ %w_2, %for.end_2 ]
	%u_5 = phi i32 [ 0, %for.end ], [ %Node.node_2, %if.then ], [ %Node.node_2, %for.end_2 ]
...
for.cond_2:
	%node_8 = phi %class.Node* [ %funcCallRet_2, %if.end ], [ %node_7, %for.inc_2 ]
	%v_5 = phi i32 [ %v_6, %if.end ], [ %Edge.to, %for.inc_2 ]
	%alt_3 = phi i32 [ %alt_4, %if.end ], [ %add, %for.inc_2 ]
	%k_7 = phi i32 [ %arrayElement_6, %if.end ], [ %arrayElement_13, %for.inc_2 ]
	%w_2 = phi i32 [ %w_3, %if.end ], [ %Edge.weight, %for.inc_2 ]
	%prefix_neg = sub i32 0, 1
	%ne_2 = icmp ne i32 %k_7, %prefix_neg
...
for.inc_2:
	%node_7 = phi %class.Node* [ %node_8, %if.then_2 ], [ %castToClassPtr_3, %if.end_2 ]
